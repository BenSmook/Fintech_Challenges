...
print("The total number of loans is", total_number_loans)


# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
total_loans = sum(loan_costs)
print("The total of all loans is", total_loans)
...
print("The average is ", avg_loan_price)
...
fair_value = (1000) / (1 + (.2 / 12)) ** 12
print("The fair value is: ", round(fair_value))
...
if loan_price >= present_value:
    print(f"This loan worth the cost to buy it.")
elif present_value < loan_price:
    print(f"Loan is too expensive!")
